import { NullablePropertiesOf } from './realm.generic.types';
...
> = TFieldType extends string
  ...
  ? 'date'
  : TFieldType extends Array<string>
  ? 'string[]'
  : TFieldType extends Array<number>
  ? 'int[]'
...
type RealmFieldsIncludingPartial<
  T extends object,
  TEntityName extends string,
> = {
  readonly [K in keyof T]-?: RealmType<T, T[K], K, TEntityName>;
